...
namespace cutee {
  namespace common {
    ...
    template<typename T> T empty_box_lower();
    template<typename T> T empty_box_upper();

    template<> float empty_box_lower<float>() { return +INFINITY; };
    template<> float empty_box_upper<float>() { return -INFINITY; };
